...
export default function Area() {
  return (
    <div className="bg-[#E3E3E3] max-[640px]:w-full max-[1280px]:w-[24rem] max-[1280px]:h-fit w-[23rem] py-2 max-[1280px]:py-4 rounded-[30px] px-4 flex flex-col max-[1300px]:px-1">
