...
export default function NamazTime({ time }: NamazProps) {
  ...
  return (
    <div className="bg-[#E3E3E3] max-[640px]:w-full max-[1280px]:w-52 rounded-[30px] flex flex-col p-4 max-[1280px]:p-2 max-[1280px]:text-center max-[1440px]:w-full text-[#177245]">
