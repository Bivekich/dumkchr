...
export default function RegionPersonalPage({
  ...
  return (
    <div className="flex-col p-8 items-center flex gap-3 rounded-[10px] flex-shrink-0  max-[560px]:p-4 w-full text-[#177245]">
      {image !== "" ? (
        <div
          className="max-[1751px]:w-[30rem] max-[1751px]:h-[35rem] w-96 h-[30rem] max-[560px]:w-[95%] max-[560px]:h-full rounded-[30px] max-[560px]:flex-shrink flex-shrink-0 bg-no-repeat bg-center bg-cover"
